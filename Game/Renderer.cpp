...
void setupView(GLuint shaderID)
{
    ...
    // Projection to map 1:1 with the window
...
int setupShader()
{
    ...
    // Checking for compilation errors (displayed via log in the terminal)
    GLint success;
    GLchar infoLog[512];
    ...
    // Linking the shaders and creating the shader program identifier
